...
#### 매물 등록 ~ 거래완료 플로우차트
<img width="1378" height="809" alt="KakaoTalk_20250828_124444362" src="https://github.com/user-attachments/assets/d5f8cf11-6575-4adc-96c6-7cad97a4c515" />


### 사용자 관리

- **회원가입/로그인**: 일반 로그인, 소셜 로그인(카카오, 네이버, 구글)
- **마이페이지**: 개인 정보(신용 정보 포함) 관리, 관심 매물 관리, 등록 매물 관리
#### 로그인 페이지 화면
<img width="1920" height="953" alt="KakaoTalk_20250828_181954139" src="https://github.com/user-attachments/assets/fd164fc1-6d70-4e0f-af6a-1e5d0d4fbf6c" />
...
#### 챗봇 플로우 차트
<img width="806" height="840" alt="chat bot" src="https://github.com/user-attachments/assets/e421b3a6-2711-4492-ac33-c8d05a1c2dc3" />
...
---------------------------------------------------------------------------------------------------------------
## 노션 주소
[[https://www.notion.so/24b406c8ade1813288a6cd3c013978db](https://www.notion.so/AI-24b406c8ade1813288a6cd3c013978db?source=copy_link)](https://neat-danger-006.notion.site/AI-24b406c8ade1813288a6cd3c013978db?source=copy_link)]

---------------------------------------------------------------------------------------------------------------
## 시연 영상
https://youtu.be/80KGIx4u6Fo
---------------------------------------------------------------------------------------------------------------
## PDF
