...
import { getVillageQna, updateVillageQna } from "../../../api/villageQnaApi";
...
const ModifyComponent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("category", "마을 Q&A");
      ...
      const response = await updateVillageQna(formData);

      if (response) {
        alert(SUCCESS_MESSAGES.UPDATE);
        navigate(`/board/village-qna/read/${boardId}`);
      }
    } catch (error) {
  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
      ...
      <div style={{ marginBottom: "25px" }}>
        <button
          onClick={() => navigate(`/board/village-qna/read/${boardId}`)}
          style={{
            padding: "10px 20px",
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          <button
            ...
            style={{
              padding: "15px 30px",
              backgroundColor: submitting ? "#ccc" : "#3b82f6",
              color: "white",
              border: "none",
              borderRadius: "8px",
